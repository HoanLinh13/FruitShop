...
public class Managerment {
    ...
    public void viewOrder(HashMap<String, ArrayList<Order>> ht) {
    ...
    public  void shopping(ArrayList<Fruit> lf, HashMap<String, ArrayList<Order>> ht) {
        ...
        while (true) {
            ...
            System.out.print("Enter quantity: ");
            int quantity = Validation.checkInputIntLimit(1, fruit.getQuantity()); fruit.setQuantity(fruit.getQuantity() - quantity);
